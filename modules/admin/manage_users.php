...
<body class="d-flex flex-column min-vh-100">
  ...
  <main class="container my-5 flex-grow-1">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h3 class="fw-bold text-primary"></i>Manage Users</h3>
    </div>
      ...
      <div class="card-body">
        <form method="get" class="row g-3">
          ...
          <div class="col-md-3 d-grid">
            <button type="submit" class="btn btn-success fw-semibold"><i class="bi bi-funnel-fill me-1"></i>Apply Filter</button>
          </div>
        </form>
      </div>
<<<<<<< HEAD
...
>>>>>>> 1d15ad97a48ed5a4ed0b2b7a7d4e305a4b69c3e9
    ...
    <div class="table-wrapper shadow-sm rounded bg-white p-3">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fw-bold text-primary m-0"></i>User List</h5>
        <a href="add_user.php" class="btn btn-primary btn-sm"><i class="bi bi-person-plus-fill me-1"></i>Add New</a>
      </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group btn-group-sm">
                      <a href="edit_user.php?id=<?= $u['user_id'] ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                      <a href="?delete=<?= $u['user_id'] ?>" class="btn btn-danger" onclick="return confirm('Delete this user?')"><i class="bi bi-trash"></i></a>
                    </div>
                  </td>
                </tr>
              <?php endwhile; ?>
